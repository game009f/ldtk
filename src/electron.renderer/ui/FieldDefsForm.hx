		...
		var i = new form.input.EnumSelect(
			...
			function(k) {
				return switch k {
					...
					case Points: curField.isArray ? L.t._("显示孤立点") : L.t._("显示孤立点");
					case PointStar: curField.isArray ? L.t._("显示连接点") : L.t._("显示连接点");
					case PointPath: L.t._("显示点的路径");
					case PointPathLoop: L.t._("显示点的路径（循环）");
					case RadiusPx: L.t._("作为半径（像素）");
					case RadiusGrid: L.t._("作为半径（基于网格）");
					case EntityTile: L.t._("替换实体切片");
					case LevelTile: L.t._("替换世界视图中的级别渲染");
